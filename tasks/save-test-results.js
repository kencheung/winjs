...
(function () {
        ...
        module.exports = function (grunt) {
            ...
            grunt.registerTask("save-test-results", function () {
                    //var done = this.async();
                    var fs = require('fs');
                    ...
                    //  http.post('http://localhost:888/?fileName=' + fullName, {
                    //     type: "addresult",
                    //     name: fileName,
                    //     content: data,
					...
					fs.writeFileSync("saucelabs-reports/reports/" + fullName + '.json', data);
            });
    };
})();
